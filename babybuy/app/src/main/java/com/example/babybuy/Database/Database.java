...
public class Database extends SQLiteOpenHelper {
    ...
    public static final String PRODUCT_COL_8 = "productlong";
    public static final String PRODUCT_COL_9 = "productcategoryid";
    ...
    public static final String PRODUCT_TABLE_CREATE = "CREATE TABLE IF NOT EXISTS " + PRODUCT_TABLE +
            ...
            + PRODUCT_COL_7 + " REAL, "
            + PRODUCT_COL_8 + " REAL, "
            + PRODUCT_COL_9 + " INTEGER REFERENCES " + CATEGORY_TABLE + "(" + CATEGORY_COL_1 + " ))";
    ...
    public long productadd(ProductDataModel productDataModel) {
        ...
        v.put(PRODUCT_COL_9, productDataModel.getProductcategoryid());
    ...
    public int deleteproductbycatid(int procatid) {
        SQLiteDatabase ddb = getWritableDatabase();
        return ddb.delete(PRODUCT_TABLE, PRODUCT_COL_9 + " = ?",
